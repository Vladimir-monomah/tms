...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 30 2022 г., 18:46
...
(4, 1, 'anuj@gmail.com', '2021-05-13', '2021-05-11', 'bvdbxb', '2021-05-13 18:53:22', 1, NULL, '2021-05-13 18:56:28');

-- --------------------------------------------------------

--
-- Структура таблицы `tblenquiry`
--
...
--
-- Дамп данных таблицы `tblenquiry`
--
...
(8, 'anuj@gmail.com', 'Booking Issues', 'fbdfgb', '2021-05-13 18:59:27', 'cv vbdb', '2021-05-13 18:59:46');
...
--
-- Структура таблицы `tbltourpackages`
--
...
--
-- Дамп данных таблицы `tbltourpackages`
--
...
--
-- Индексы таблицы `tblenquiry`
--
ALTER TABLE `tblenquiry`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tblissues`
--
...
--
-- Индексы таблицы `tbltourpackages`
--
...
--
-- AUTO_INCREMENT для таблицы `tblenquiry`
--
ALTER TABLE `tblenquiry`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `tblissues`
--
ALTER TABLE `tblissues`
...
--
-- AUTO_INCREMENT для таблицы `tbltourpackages`
--
ALTER TABLE `tbltourpackages`
